    ...
    <nav>
            ...
            <button onclick="myFunction()" class="dropbtn"><b style="background-color:#ff7f2a";><a >SCHEDULE</a></b></button>
                   ...
                   <div id="myDropdown" class="dropdown-content">
                    ...
                    <li><a class="active" href='http://localhost/raj/userchatdisplay.php'><b>MESSAGE</b></a></li>
...
$username = ucfirst ($_SESSION['user_name']);
  ...
  if($data)
  {
        ...
        ?>
<meta http-equiv="refresh" content="0; url = http://localhost/raj/userchatdisplay.php">
    <?php
  }
  else 
  {
