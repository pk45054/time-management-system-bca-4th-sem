...
if($total != 0)
{
	...
	<h3 align="center"><a href='notification.php'><input type='submit' value='Add Notify' class='chat'></a></h3><br>
	...
	echo "<tr>
		      ...
		      <td>
		      <a href='notifydelete.php?id=$result[id]'><input type='submit' value='Delete' class='delete' onclick='return checkdelete()'></a></td>   
		</tr>
		";  
    }
}else
{
	...
	echo "<tr>";
		      ...
		      echo"<a href='notifydisplay.php'>";echo"<input type='submit' value='Delete' class='delete' onclick='return checkdata()'>";echo"</a>";echo"</th>";   
		echo"</tr>";
      echo "</table>";
